...
describe BillsController do
  ...
  describe "handling GET /bills.xml" do

    before(:each) do
      @bill = mock_model(Bill, :to_xml => "XML")
      Bill.stub!(:find).and_return(@bill)
    end
    ...
    it "should render the found bills as xml" do
      @bill.should_receive(:to_xml).and_return("XML")
      do_get
  ...
  describe "handling GET /bills/1.xml" do
    ...
    it "should render the found bill as xml" do
      @bill.should_receive(:to_xml).and_return("XML")
      do_get
      response.body.should == "XML"
    end
